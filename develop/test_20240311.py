...
field='FRP'
output_folder="D:\Lenovo\Desktop\云南大学\大创\程序代码\空间权重矩阵测试\阈值权函数结果\考虑高程_黄淮海平原逐月_阈值权_FRP_55KM"
cal_moran_2.global_moran_folder(folder_path,field,output_folder,distance_function='threshold',threshold=55000,elevation=True)